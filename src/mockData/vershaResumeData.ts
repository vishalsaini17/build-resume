...
export const resumeInfo2: resumeData = {
  ...
  experience: [
    {
      ...
      achievements: {
        ...
        list: [
          ...
          {
            title: "Adani Digital Flight Booking",
            description: `
    ...
    },
    {
      ...
      endAt: "Apr 2022",
      location: "Gurugram",
      summary: `<p> Its a platform to learn online yoga through all over the world , they has teachers according to their courses where can book a
      session according to their time suitability. <p>`,
      workInfo: {
  ...
  educations: [
    {
      instituteName: "Pt. J.L.N College ",
      courseName: "M.com",
      fieldOfStudy: "Masters of Commerce",
      startAt: "2015",
      endAt: "2017",
      grade: "55%",
    ...
    {
      instituteName: "Govt College Of Woman ",
      courseName: "B.com",
      fieldOfStudy: "Bachelors of Commerce",
      startAt: "2012",
      endAt: "2015",
      grade: "58%",
      university: "Maharshi Dayanand University (MDU)",
